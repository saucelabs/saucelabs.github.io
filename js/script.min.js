...
parallaxBox.onmousemove=function(event){event=event||window.event
...
function mouseParallax(id,left,top,mouseX,mouseY,speed){const obj=document.getElementById(id)
